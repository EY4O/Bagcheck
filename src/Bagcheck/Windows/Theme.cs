...
/// <summary>
/// Bagcheck's look: dark panels, rounded frames and one accent colour. It's pushed only around Bagcheck's own windows,
...
/// <summary>A window that wears the Bagcheck theme while it draws.</summary>
